...
const Dashboard = () => {
  return (
    <div className="p-8 w-full">
        ...
        <ul className="list-disc list-inside space-y-2 text-red-600">
          {alertsData.map((alert, index) => (
            <li key={index} className="flex items-start">
              ...
              <button className="ml-4 text-sm text-otacos-blue hover:text-otacos-accent font-bold">
                (Voir/Résoudre)
              </button>
            </li>
          ))}
      ...
      {/* GRAPHIQUES ET ANALYSES SIMULÉES (à remplacer par des libs comme Chart.js) */}
